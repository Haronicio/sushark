...
public class Segment {
    ...
    public Segment(RawFrame segment) {
        ...
        // Flags
        flags_char = header_flags.toCharArray();
        flags_str += "\n\t\t000. .... .... = Reserved: Not set";

        String nonce_txt = "Not set";
        char nonce = flags_char[7];
        if (nonce == '1') {
            nonce_txt = "Set";
        }
